...
class ResponseCache(Generic[KV]):
    ...
    def __init__(self, clock: Clock, name: str, timeout_ms: float = 0):
        self.result_cache: Dict[KV, ResponseCacheEntry] = {}
    ...
    def _set(
        ...
        *deferred* should run its callbacks in the sentinel logcontext (ie,
        ...
        entry = ResponseCacheEntry(result)
        self.result_cache[key] = entry
        ...
        def on_complete(r: RV) -> RV:
            ...
            if self.timeout_sec and context.should_cache:
                self.clock.call_later(
                    self.timeout_sec, self.result_cache.pop, key, None
                )
            else:
